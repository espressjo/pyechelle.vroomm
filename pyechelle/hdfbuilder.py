...
if __name__ == "__main__":
    ...
    # Add here so many fiber/fields as you wish. You don't have to fiddle with the fields in OpticStudio. The
    ...
    # and it will/should pull the appropriate values from ZEMAX
